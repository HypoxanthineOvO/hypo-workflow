...
The repository currently has 36 local Skill files under `skills/*/SKILL.md`:
...
- Root `SKILL.md` is the aggregate Hypo-Workflow router and system reference. It is not counted as a child Skill in the 36 local Skill files.
...
- `skills/watchdog/SKILL.md` is a valid internal exception: it is cron-only, should not be user-invocable, and should not be counted among the 33 user-facing Skill paths.
