...
| Compact | `/hw-compact` | `hw-status` | Generates compact files and pairs with OpenCode `session.compacted`. |
...
| Debug | `/hw-debug` | `hw-build` | Symptom-driven debug through canonical debug skill. |
