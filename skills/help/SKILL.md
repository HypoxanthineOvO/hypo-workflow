...
Use this skill to explain the 37 user-facing Hypo-Workflow commands and the internal watchdog skill.
...
1. By default, list all 37 user-facing commands grouped by category.
