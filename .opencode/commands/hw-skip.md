---
agent: hw-build
description: Hypo-Workflow mapping for /hw:skip
---
...
Load the corresponding Hypo-Workflow skill instructions from `skills/skip/SKILL.md`, then execute the canonical command semantics with any user-provided arguments.
