...
Load the corresponding Hypo-Workflow skill instructions from `skills/reject/SKILL.md`, then execute the canonical command semantics with any user-provided arguments.
