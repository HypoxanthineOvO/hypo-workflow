...
Load the corresponding Hypo-Workflow skill instructions from `skills/resume/SKILL.md`, then execute the canonical command semantics with any user-provided arguments.
