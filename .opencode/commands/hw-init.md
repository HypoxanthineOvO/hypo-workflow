---
agent: hw-plan
description: Hypo-Workflow mapping for /hw:init
---
...
Load the corresponding Hypo-Workflow skill instructions from `skills/init/SKILL.md`, then execute the canonical command semantics with any user-provided arguments.
